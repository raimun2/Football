...
setwd("D:/Users/Italo/Documents/Italo Felipe/Proyectos/Futbol Analitycs/2020/FutbolAnalytics/Data/U20 Womens World Cup Francia 2018")
...
write.table(data_primertiempo, "MundialAdulto_FemeninoFrancia2019_PrimerTiempo.csv", row.names=FALSE, sep = ",")
write.table(data_segundotiempo, "MundialAdulto_FemeninoFrancia2019_SegundoTiempo.csv", row.names=FALSE, sep = ",")

data_primertiempo[is.na(data_primertiempo)] <- 0

str#Orden Data Frames
...
as.numeric(data_primertiempo[,c("saves","totalClearance","wonTackle","totalThrows",
"penaltyConceded","penaltyFaced","penGoalsConceded","penaltySave","totalTackle","totalYellowCard","secondYellow",   
"totalRedCard","lostCorners","fkFoulLost","goalsConceded","ownGoals","totalPass","accuratePass","goals","goalAssist","totalScoringAtt","ontargetScoringAtt",
"blockedScoringAtt","shotOffTarget","goalKicks","penaltyWon","fkFoulWon","totalOffside","wonCorners",
"cornerTaken","cleanSheet","possessionPercentage","possessionPercentageRival","minPrimerGol","golesAfavorHT",
"golesEnContraHT","subsMade"
)])

data_segundotiempo[,c("saves","totalClearance","wonTackle","totalThrows",
                     "penaltyConceded","penaltyFaced","penGoalsConceded","penaltySave","totalTackle","totalYellowCard","secondYellow",   
                     "totalRedCard","lostCorners","fkFoulLost","goalsConceded","ownGoals","totalPass","accuratePass","goals","goalAssist","totalScoringAtt","ontargetScoringAtt",
                     "blockedScoringAtt","shotOffTarget","goalKicks","penaltyWon","fkFoulWon","totalOffside","wonCorners",
                     "cornerTaken","cleanSheet","possessionPercentage","possessionPercentageRival","minPrimerGol","golesAfavorHT",
